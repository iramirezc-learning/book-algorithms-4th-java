...
/**
 * Type: ADT
 * Description: SET based on Red-Black Binary Search Trees.
 * Ref: p. 439, 489
 *
 * Compilation: javac SET.java
 * Execution: java SET < <input_stream>
 *
 * $ java SET < ~/algs4-data/custom/search-example.txt
 * A
 * C
 * E
 * H
...
public class SET<Key extends Comparable<Key>> {
  ...
  private class Node {
    private Key key; // key
    private Node left, right; // links to left and right sub-trees
  ...
  ***************************************************************************/
  ...
  /**
   * Returns the the given key if exits in the Symbol table and null otherwise.
  ...
  // returns the key if exits in the subtree; null if no such key
  ...
  ***************************************************************************/
  ...
  // delete the given key rooted at h
